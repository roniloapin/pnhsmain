          ...
          <div class="col-md-12" >
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">System Users - Teacher</h3>

                <div class="card-tools">
                  <button type="button" class="btn btn-success" @click="newModal">Add Teacher <i class="fas fa-user-plus fa-fw"></i></button>
                </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title fas fa-user-plus" v-show="!editMode" id="addNewTitle"> Add New Teacher</h5>
              <h5 class="modal-title fas fa-user-edit" v-show="editMode" id="addNewTitle"> Update Teacher</h5>
        ...
        methods:{
          ...
          createUser(){
            ...
            .then(()=>{               //if successful then
              ...
              $('#addNew').modal('hide')
              Swal.fire('Added New Account!', '', 'success')
